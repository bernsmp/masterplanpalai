...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>${k?`${k} has invited you to`:"Join us for"} ${e}</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="venue-card">
                <h3 class="venue-name">${i.name}</h3>
                <p class="venue-address">${i.address}</p>
                ${i.rating?`
                <div class="venue-rating">
                    <span class="stars">${"★".repeat(Math.floor(i.rating))}${"☆".repeat(5-Math.floor(i.rating))}</span>
                    <span class="rating-text">${i.rating}/5 stars</span>
                </div>
                `:""}
            </div>
            `:""}
            ...
            <div class="rsvp-section">
                ...
                <a href="${l}" class="rsvp-button">RSVP Now</a>
            </div>
        </div>
