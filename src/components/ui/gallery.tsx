    ...
    <div className="mt-8 relative">
      ...
      <div className="flex justify-center mb-8">
        <HeroPill 
          ...
          className="[&>p]:!bg-[#ffb829] [&>p]:!text-black [&>p]:!dark:bg-[#ffb829] [&>p]:!dark:text-black"
        />
      </div>

      {/* Main Title */}
      <h3 className="z-20 mx-auto max-w-4xl justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text py-3 text-center text-4xl text-transparent dark:bg-gradient-to-r dark:from-slate-100 dark:via-slate-200 dark:to-slate-100 dark:bg-clip-text md:text-7xl">
        Making Plans That <span className="text-[#ffb829]">Actually Happen</span>
      </h3>
      
      {/* Subtitle */}
      <p className="lg:text-md my-6 text-center text-lg font-light text-slate-600 dark:text-slate-400">
        Because someone has to organize this group.
      </p>
